...
@auto_docstring
@registry.register_model("EvalLlamaModel")
class EvalLlamaModel(LlamaPreTrainedModel):
...
@auto_docstring
@registry.register_model("EvalLlamaForCausalLM")
class EvalLlamaForCausalLM(LlamaPreTrainedModel, GenerationMixin):
